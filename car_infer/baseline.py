...
class Tensor_CSPNet(nn.Module):
    def __init__(self, channel_num, mlp, dataset="Car"):
        ...
        self.Temporal_Block = nn.Conv2d(
            1,
            self.tcn_channels,
            (self.kernel_size, self.tcn_width * self.dims[-1] ** 2),
        ...
        # else:
        # self.Classifier = nn.Linear(self.tcn_channels, classes)
    ...
    def __init__(self, channel_num, P, mlp, dataset="KU"):
        ...
        if self._mlp:
            ...
            self.Classifier = nn.Linear(
                channel_num * self.dims[-1] ** 2, classes
            ).double()
